...
public class RectangleOptions extends JPanel {
    ...
    /**
     * The JSpiner that allows the user to pick the outline stroke.
     */
    private static JSpinner spinner;
    
    /**
     * Setup the JSPinner, spinner, with the max, min values.
     */
    static {
        int min = 0;
        int value = 1;
    ...
    /**
     * Create a new RectangleOptions, the constructor does most the
     * work as most of it is GUI work.
     */
    public RectangleOptions() {
        this.setLayout(new FlowLayout());
        this.add(new JLabel(
                JVector.getRBLocale().getString("ExtraBar.Rectangle.OutlineWeight")));
        this.add(spinner);
    }
    
    /**
     * Get the stroke set. (the weight/thickness of the outline)
     * 
